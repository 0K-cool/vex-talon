...
- **RENAMED:** Vex-Talon → 0K-Talon across all packages, documentation, and configuration
- Package scopes renamed: `@vex-talon/*` → `@0k-talon/*`
- Config directory: `~/.vex-talon/` → `~/.0k-talon/`
- GitHub repository: `0K-cool/vex-talon` → `0K-cool/0k-talon` (old URLs auto-redirect)
