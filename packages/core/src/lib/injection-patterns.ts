...
// Unicode normalization imported from shared module: ../hooks/lib/unicode-normalize
// Re-export normalizeForScanning for consumers that import from this module
export { normalizeForScanning };
